...
You can order an assembled Acquisition Board from `Open Ephys Production Site <https://open-ephys.org/acquisition-system/oeps-9029?rq=acquisition%20board>`_. You can also order an `Open Ephys Starter Bundle <https://open-ephys.org/acquisition-system/starter-bundles-3d>`_, which contains everything you need to get started (except for electrodes and a computer).
